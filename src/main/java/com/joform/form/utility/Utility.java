package com.joform.form.utility;

import com.joform.form.drivermanager.ManageDriver;
...
//*************************** Select Class Methods ***************************************//
    ...
    public void selectMenu(WebElement element, String menu) throws InterruptedException {

        List<WebElement> names = (List<WebElement>) element;
        for (WebElement name : names) {
            //Thread.sleep(2000);
            if (name.getText().equalsIgnoreCase(menu)) {
                Thread.sleep(2000);
